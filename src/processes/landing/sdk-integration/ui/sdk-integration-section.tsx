...
function SDKIntegrationSection() {
    return (
        <CenteredGroup className='gap-10 lg:gap-20 text-left'>
            <ThinSectionTitle className='text-gray-900 text-left!'>
            ...
            <TextAndMediaGroup breakEarly>
                <div className='flex flex-col gap-10 text-foreground'>
                    <p className='text-lg sm:text-[1.4rem] md:text-2xl leading-relaxed text-gray-700'>
                    ...
                    <div className='flex gap-4 items-center text-lg sm:text-[1.4rem] md:text-2xl mb-6 text-gray-900 font-medium'>
