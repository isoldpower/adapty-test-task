...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Overlay
    className={cn(
      "cn:fixed cn:inset-0 cn:z-50 cn:bg-black/80 cn:data-[state=open]:animate-in cn:data-[state=closed]:animate-out cn:data-[state=closed]:fade-out-0 cn:data-[state=open]:fade-in-0",
      className
    )}
    {...props}
    ref={ref}
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Title
    ref={ref}
    className={cn("cn:text-lg cn:font-semibold", className)}
    {...props}
  />
))
